...
function savePropertyToDatabase($property) {
    ...
    $stmt = $conn->prepare("INSERT INTO properties (name, location, age, floorPlan, numOfBeds, numOfBath, garden, price, imageURL)
     VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)");
    $stmt->bind_param("sssssssss", $property['name'], $property['location'], $property['age'],
    $property['floorPlan'], $property['numOfBeds'],$property['numOfBath'], $property['garden'], 
    $property['price'], $property['imageURL']);
